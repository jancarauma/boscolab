...
<p>
   ...
   Boscolabomatically add a new data table cell to the 
...
<p>
   Boscolab can now do spreadsheets with Excel and CSV import! Additionally,
   ...
   stdev, stdevp, range, and count).
    See the
   <a href="https://boscolab.vercel.app/hnh9wDMhEfXjDPUzpn9cTS" target="_blank">
      data table tutorial
   </a> 
   for details.
</p>
...
<p>
   Parametric plotting has been added to Boscolab. See the
   <a href="https://boscolab.vercel.app/dcM95gSLeCTcbCHtsM4uqq" target="_blank">
...
<p>
   ...
   <a href="http://www.coolprop.org/" target="_blank">CoolProp library</a>, Boscolab 
   ...
   <a href="https://boscolab.vercel.app/mWf3zkzQEmYsUPckCPX5P8" target="_blank">thermodynamic 
      fluids tutorial</a> 
   to get started!
</p>
<br>
...
<p>
   ...
   with 
   <a href="https://github.com/engjango/boscolab/issues/156" target="_blank">derivatives</a>
   and
   <a href="https://github.com/engjango/boscolab/issues/244" target="_blank">integrals</a>
...
<p>
   Math fields in Boscolab now support a custom context menu for 
...
<p>
   ...
   Boscolab File Management Tutorial Video</a>. Unfortunately, Firefox and 
...
<p>
   You're now able to export your Boscolab sheets as Microsoft Word,
   ...
   to the Boscolab servers to complete the conversion process. However, no 
   data is retained after the document conversion process is complete. The Markdown 
   document export option does not require sending any data to the Boscolab 
   servers. Enjoy!
</p>
...
<h4>Now Also Available as <a href="https://boscolab.com" target="_blank">boscolab.com</a></h4>
<p>
...
<br>
<p>
   As in the past, the default unit system for Boscolab sheets is the 
...
<p>
   ...
   <a href="https://blog.boscolab.com.br/calculating-the-natural-frequencies-of-a-cantilever-beam"
      target="_blank">
   blog post</a> for details on how to properly
   handle frequency units in Boscolab.
</p>
...
<p>
   Scatter plots are now supported by Boscolab. Scatter plotting
   leverages the recently added ability to define vectors. See the 
   <a href="https://boscolab.vercel.app/32XmqQA442GL8mj8X9uwP3" target="_blank">
...
<p>
   This release adds matrix and vector support. Just like all of the capabilities in Boscolab, 
   ...
   <a href="https://boscolab.vercel.app/8pWM9yEqEPNntRBd6Jr9Sv" target="_blank">Matrices and Vectors Tutorial</a> 
   to see all of the details. And, of course, all of the matrix and vector functionally has full units support.
</p>
<br>
<p>
   If you're finding the need to do more in depth numerical analysis with your Boscolab calculations, 
   the new automatic Python code generation feature is for you! Check out the details in the new
   <a href="https://boscolab.vercel.app/enYmu2PzN2hN93Avizx9ec" target="_blank">Python Code Generation Tutorial</a>. 
...
<ul>
   ...
   <li>A Boscolab link can be dragged and dropped onto page to open (similar to existing functionality for files)</li>
   ...
   <li>The <a href="https://boscolab.vercel.app/VteDKCkA8fREy7hLYLMwEQ" target="_blank">tutorial page</a> has been updated for recent features and now points to the <a href="https://youtu.be/r7EZQVhcr5Q" target="_blank">new and updated tutorial video</a></li>
</ul>
...
<p>
   ...
   <a href="https://github.com/engjango/boscolab/issues">
   GitHub issue</a>.
</p>
<br>
...
<p>
   Up until this time, Boscolab has been using the MathQuill 
   ...
   can be implemented in Boscolab. Specifically, MathQuill does
   not support vectors and matrices. To enable the future advancement of 
   Boscolab, the math editor has been updated to use the 
...
<p>
   ...
   <a href="https://github.com/engjango/boscolab/issues" target="_blank">GitHub issues page</a>,
   or reported on the
   <a href="https://www.reddit.com/r/boscolab/" target="_blank">Reddit community page</a>. 
   In the case that you are having a issue opening an existing sheet or working with the math 
   editor, the previous version of Boscolab will remain available at 
   <a href="https://classic.boscolab.com.br" target="_blank">classic.boscolab.com.br</a>. 
   Keep in mind that sheets created in this and later versions of Boscolab 
   will not open in classic.boscolab.com.br
</p>
<br>
<p>
   ...
   <a href="https://boscolab.vercel.app/c2YzvRRDNx3zYrY7dKDa92" target="_blank">example sheet</a>.
   Many thanks to <a href="https://github.com/JWock82" target="_blank">@JWock82</a> for
   submitting these feature suggestions as a
   <a href="https://github.com/engjango/boscolab/issues">
   GitHub issue</a>.
...
<p>
   The version of Python that Boscolab uses for calculations, via the Pyodide project,
   ...
   about half of what it was for the Python 3.10 version of Boscolab. Enjoy!
</p>
<br>
...
<p>
   Some improvements have been made to Boscolab
...
<br>
<p>
   As a community project, Boscolab depends on feedback from its users. If you 
   have a feature request or are experiencing a bug, there are multiple ways to report these 
   issues. You can create an issue in Boscolab's 
   <a href="https://github.com/engjango/boscolab/issues">GitHub issues page</a>, 
   you can add a post to Boscolab's 
   <a href="https://www.reddit.com/r/boscolab/">Reddit community page</a>, or you
   can send a email to <a href="mailto:suporte@boscolab.com.br">suporte@boscolab.com.br</a>.
   Also, if you would like to share any of the sheets you are creating with 
   Boscolab, the  <a href="https://www.reddit.com/r/boscolab/">Reddit community page</a> is a great 
   place to share and start a discussion.
</p>
<br>

<em>February 13, 2023</em>
<h4>Boscolab Can Now be Installed on Desktop or Mobile Devices</h4>
<p>
   Boscolab is now a progressive web application (PWA). The biggest impact of this 
   change is that Boscolab will now work without an internet connection 
...
<br>
<p>
   Another benefit of this change will be smoother rollouts of updates to Boscolab. 
   In the past, it was possible for various components of Boscolab to become temporarily
   out of sync as updates were rolled out globally. Boscolab will now only incorporate an
   ...
   all tabs and windows of Boscolab need to be closed. Using the refresh button is not 
...
<p>
   To ensure that Boscolab always remains free to use, it has now been released as open source 
   software under the permissive MIT license. The source code can be found on the
   <a href="https://github.com/engjango/boscolab" target="_blank">
    Boscolab GitHub page
   </a>. With this 
   change, you can rest assured that Boscolab will always be available and that your
...
<p>
   ...
   along with the open source license of Boscolab, you are assured that you will always have
   access to the calculations you create in Boscolab. The {modifier}-S keyboard shortcut
   ...
   {modifier}-Shift-N key starts a new blank sheet. Boscolab sheets have an .blab 
   extension by default. Another way to open your saved sheets is to drag and drop them
   onto the Boscolab window.
</p>
<br />
...
<p>
   Many updates have been made to improve printing of Boscolab sheets. Document flow issues
...
<p>
   Boscolab now automatically saves checkpoints of your sheet to prevent loss of data in the event
...
<p>
   The experience of using Boscolab on iPhone and Android devices has been improved significantly. 
...
<p> <em>New Features:</em> The complex number support has been improved with
   Boscolab with the addition of the real, imag, conj, and angle functions
   (see the Imag tab added to the onscreen keyboard to access these new functions). If you prefer to learn
   by example, check out this <a href="https://blog.boscolab.com.br/plotting-gain-and-phase-for-a-general-voltage-divider" target="_blank">
...
<p>
   A comprehensive set of keyboard shortcuts have been added to Boscolab that allow you to 
   ...
   or see this 
   <a href="https://blog.boscolab.com.br/boscolab-keyboard-shortcuts" target="_blank">
...
<p>
   ...
   see bottom of the <a href="https://boscolab.vercel.app/TxAftUqQCmXKNPX5XGBUy8" target="_blank">
...
<h4>Plotting Improvements</h4>
<p>
   Many improvements have been made to plotting in Boscolab. The biggest new feature 
   ...
   create a plot. See the <a href="https://boscolab.vercel.app/TxAftUqQCmXKNPX5XGBUy8" target="_blank">
...
<p>
   Boscolab now supports numerically solving equations and systems
   of equations in situations where the symbolic solver may not be able to find an exact
   solution. See the
   <a href="https://boscolab.vercel.app/DeP4bqfF2H5VbRJz3Nd9Re" target="_blank"> 
...
<h4>New System Solve Cell Type Added to Boscolab</h4>
<p>
   The way Boscolab handles equation solving has been updated and
   ...
   choose a particular solution when there are multiple solutions. <strong
      ...
      <a
         href="https://boscolab.vercel.app/ZfMZ7rsE4hJz63n7UXKTJa"
   ...
   in future versions of Boscolab.
</p>

<br />
<em>September 19, 2022</em>
<h4>New Piecewise Function Cell Type Added to Boscolab</h4>
<p>
   Piecewise functions can now easily be added to Boscolab sheets.
   Check out this <a
      href="https://boscolab.vercel.app/o5iBpjybLJgNxybFxrJEiT"
...
<br />
<em>June 17, 2022</em>
<h4>New Insert Sheet Feature Added to Boscolab</h4>
<p>
...
<br />
<em>June 8, 2022</em>
<h4>New Table Cell Type Added to Boscolab</h4>
<p>
...
<h4>Plotting and Function Notation Have Been Added to Boscolab</h4>
<p>
   Check out this <a
      href="https://boscolab.vercel.app/MNsS9tjtLLzcBTgTNboDiz"
      target="_blank">example sheet</a
