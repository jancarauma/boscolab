...
export const baseUnitChoices: {name: string, label: string, choices: string[]}[] = [
  {name: 'mass', label: 'Massa', choices: ['kg', 'g', 'mg', 'tonelada', 'lbm', 'ton', 'oz'] },
  {name: 'length', label: 'Comprimento', choices: ['m', 'mm', 'cm', 'km', 'um', 'nm', 'angstrom', 'in', 'pé', 'jarda', 'milha']},
  {name: 'area', label: 'Área', choices: ['m^2', 'cm^2', 'mm^2', 'km^2', 'hectare', 'in^2', 'pé^2', 'jarda^2', 'milha^2', 'acre']},
  {name: 'volume', label: 'Volume', choices: ['m^3', 'cm^3', 'mm^3', 'km^3', 'litro', 'ml', 'in^3', 'pé^3', 'jarda^3', 'milha^3', 'galão', 'floz']},
  {name: 'force', label: 'Força', choices: ['N', 'mN', 'kN', 'lbf', 'kip', 'dyne', 'gf', 'kgf']},
  {name: 'pressure', label: 'Pressão', choices: ['Pa', 'kPa', 'MPa', 'GPa', 'psi', 'kpsi', 'Mpsi', 'atm', 'torr', 'bar', 'mmHg', 'mmH2O', 'cmH2O', 'inHg', 'inH2O', 'ftH2O']},
  {name: 'energy', label: 'Energia', choices: ['J', 'mJ', 'kJ', 'MJ', 'Wh', 'kWh', 'eV', 'BTU', 'hp*hr', 'N*m', 'in*lbf', 'pé*lbf', 'dyn*cm', 'erg']},
  {name: 'power', label: 'Potência', choices: ['W', 'mW', 'kW', 'MW', 'hp', 'BTU/min', 'BTU/seg', 'BTU/hr', 'MBH', 'MMBH', 'TR', 'BHP', 'erg/seg', 'dyne*cm/seg']},
  {name: 'angle', label: 'Ângulo', choices: ['rad', 'grau', 'grad', 'ciclo', 'arcseg', 'arcmin']},
  {name: 'time', label: 'Tempo', choices: ['s', 'ms', 'us', 'ns', 'min', 'hora', 'dia', 'semana', 'mês', 'ano']},
  {name: 'temperature', label: 'Temperatura', choices: ['K', 'degC', 'degF', 'degR']},
  {name: 'charge', label: 'Carga Elétrica', choices: ['C', 'mC', 'uC', 'nC', 'pC']},
  {name: 'electric_potential', label: 'Potencial Elétrico', choices: ['V', 'mV', 'kV', 'uV', 'MV']},
  {name: 'current', label: 'Corrente Elétrica', choices: ['A', 'mA', 'uA', 'kA', 'MA']},
  {name: 'resistance', label: 'Resistência', choices: ['ohm', 'mohm', 'kohm', 'Mohm', 'Gohm']},
  {name: 'capacitance', label: 'Capacitância', choices: ['F', 'mF', 'uF', 'nF', 'pF']},
  {name: 'inductance', label: 'Indutância', choices: ['H', 'mH', 'uH', 'nH', 'pH']},
  {name: 'conductance', label: 'Condutância', choices: ['S', 'mS', 'kS', 'uS', 'MS']},
  {name: 'magnetic_flux', label: 'Fluxo Magnético', choices: ['Wb', 'mWb', 'uWb', 'nWb']},
  {name: 'magnetic_flux_density', label: 'Densidade de Fluxo Magnético', choices: ['T', 'mT', 'uT', 'nT','pT']},
  {name: 'luminous_intensity', label: 'Intensidade Luminosa', choices: ['cd', 'mcd', 'kcd']},
  {name: 'amount_of_substance', label: 'Quantidade de Substância', choices: ['mol', 'kmol', 'mmol']},
  {name: 'information', label: 'Informação', choices: ['b', 'B', 'kB', 'MB', 'GB', 'TB', 'PB', 'kb', 'Mb', 'Gb', 'Tb', 'Pb']},
];
